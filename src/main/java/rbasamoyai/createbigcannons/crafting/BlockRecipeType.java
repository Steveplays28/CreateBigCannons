...
public interface BlockRecipeType<T extends BlockRecipe> extends RegistryEntry<BlockRecipeType<?>> {
	...
	class Simple<T extends BlockRecipe> extends RegistryEntry<BlockRecipeType<?>> implements BlockRecipeType<T> {
	...
	class Builder<T extends BlockRecipe, P> extends AbstractBuilder<BlockRecipeType<?>, BlockRecipeType<T>, P, Builder<T, P>> {
		...
		@Override
		protected @NonnullType BlockRecipeType<T> createEntry() {
		...
		@Override
		protected Entry<T> createEntryWrapper(RegistryObject<BlockRecipeType<T>> delegate) {
